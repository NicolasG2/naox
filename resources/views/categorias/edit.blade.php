@extends('templates.header', ['menu' => 'admin', 'submenu' => 'Alterar Categoria', 'rota' => 'categorias.create'])
...
@section('conteudo')
    ...
    <form action="{{ route('categorias.update', $categorias->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control @if ($errors->has('nome')) is-invalid @endif"
                        name="nome" placeholder="nome" value="{{ $categorias->nome }}" />
        ...
        <div class="row">
            <div class="col">
                <div class="form-floating mb-3">
                    <select class="form-control @if ($errors->has('area')) is-invalid @endif" name="area">
        ...
        <div class="row">
            <div class="col">
                <a href="{{ route('categorias.index') }}" class="btn-voltar btn btn-secondary btn-block align-content-center">
